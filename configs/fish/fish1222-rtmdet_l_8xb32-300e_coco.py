_base_ = [
    ...
    '../_base_/datasets/fish1222_detection.py', './rtmdet_tta.py'
]
model = dict(
    type='RTMDet',
...
vis_backends = [dict(type='TensorboardVisBackend')]  # 可视化后端，请参考 https://mmengine.readthedocs.io/zh_CN/latest/advanced_tutorials/visualization.html
visualizer = dict(
